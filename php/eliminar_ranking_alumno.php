<?php 
  ...
  $comprobar = mysqli_query($conexion, "SELECT * FROM ranking_alumnos WHERE Id_Ranking='$params-> info'");
  class Result {}
  ...
  $resultado = "DELETE  FROM ranking_alumnos WHERE Id_Ranking='$params-> info'";
